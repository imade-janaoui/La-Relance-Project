...
<form action="service.php" method="post" class="form_horen_test" enctype="multipart/form-data">
            ...
            ?>
             <option value="<?php echo $row["id_groupe"] ?>"> <?php echo $row["nom_groupe"] ?> </option>
                ...
                <span>
                   <input type="text" name="chapitre_name"  placeholder=" Le nom chaptre">
        ...
        <div class="button_submit">
            <button type="submit" name="chapitre_save" id="Sauvegarder">Sauvegarder</button>
      </div>
